...
test('render Contact1 component with errors', () => {
  const div = document.createElement('div')
  ReactDOM.render(<Contact1 />, div)
})

test('render Contact1 component without login', () => {
  const div = document.createElement('div')
  ReactDOM.render(
    <Contact1
      pageData={{
...
test('render Contact1 component with login', () => {
  const div = document.createElement('div')
  ReactDOM.render(
    <Contact1
      isLoggedIn={true}
