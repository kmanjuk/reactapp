...
test('render Contact4 component without crashing', () => {
  const div = document.createElement('div')
  ReactDOM.render(<Contact4 />, div)
})

test('render Contact4 component without login', () => {
  const div = document.createElement('div')
  ReactDOM.render(
    <Contact4
      pageData={{
        mapURL: {
          mapURL:
            'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2685.7349443592966!2d-122.12893798436659!3d47.689567279190236!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x54900d47dec8e9dd%3A0xaebef8ca6e83353b!2sBal%20Bhavan%20Family%20Home%20Child%20Care%20Center!5e0!3m2!1sen!2sin!4v1666460891262!5m2!1sen!2sin',
        },
      }}
    />,
    div,
...
test('render Contact4 component with login', () => {
  const div = document.createElement('div')
  ReactDOM.render(
    <Contact4
      isLoggedIn={true}
